...
from .views import Home, Profile, Signin, signout, CreatedBankAccount, MakeTransection, account_detail, LastTransections, CalculateLoanPoint, CollectLoan, LoanList,LoanInstallmentList,LoanInstallmentPayment, ChangePassword
